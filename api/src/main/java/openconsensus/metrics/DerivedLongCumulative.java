...
/**
 * Derived Long Cumulative metric, to report cumulative measurement of a long value. Cumulative
 ...
 */
@ThreadSafe
public interface DerivedLongCumulative extends Metric {
  /**
  ...
  /** Builder class for {@link DerivedLongCumulative}. */
  interface Builder extends Metric.Builder<Builder, DerivedLongCumulative> {}
}
